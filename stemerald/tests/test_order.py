...
class OrderTestCase(WebTestCase):
    ...
    def test_order_get(self):
        ...
        self.assertIsNotNone(response[0]['createdAt'])
        self.assertIsNotNone(response[0]['modifiedAt'])
        self.assertIsNone(response[0]['finishedAt'])
        self.assertIsNotNone(response[0]['market'])
        self.assertIsNotNone(response[0]['user'])
        self.assertIsNotNone(response[0]['side'])
        self.assertIsNotNone(response[0]['amount'])
        self.assertIsNotNone(response[0]['price'])
        self.assertIsNotNone(response[0]['takerFeeRate'])
        self.assertIsNotNone(response[0]['makerFeeRate'])
        self.assertIsNotNone(response[0]['source'])
        self.assertIsNotNone(response[0]['filledMoney'])
        self.assertIsNotNone(response[0]['filledStock'])
        self.assertIsNotNone(response[0]['filledFee'])
        ...
        self.assertIsNotNone(response[0]['finishedAt'])
        self.assertIsNotNone(response[0]['market'])
        self.assertIsNotNone(response[0]['user'])
        self.assertIsNotNone(response[0]['side'])
        self.assertIsNotNone(response[0]['amount'])
